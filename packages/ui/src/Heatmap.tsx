...
/*
  ...
  три месяца: карта помещается целиком, правым краем упирается в текущую
  неделю, и при этом не занимает пол-экрана по высоте.
*/
const COMPACT_QUERY = '(max-width: 900px)';
const COMPACT_WEEKS = 13;
const COMPACT_CELL = 19;
